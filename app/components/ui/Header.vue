...
<template>
  ...
  >
    <UiAvatar class="size-9 border border-md-surface-variant bg-md-surface-container-high">
    ...
    <div class="flex items-center gap-1.5">
      ...
      <h1 class="font-heading text-lg uppercase tracking-[-0.02em] text-foreground">Hadeed</h1>
    </div>

    <div class="flex items-center gap-1.5 rounded-full bg-md-surface-container-high py-1 pl-2 pr-3">
      ...
      <span class="font-mono text-xs font-bold [font-variant-numeric:tabular-nums]">
        ...
        <span class="text-foreground">24</span>
      </span>
    </div>
  </nav>
</template>
